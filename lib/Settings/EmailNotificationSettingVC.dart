...
class EmailNotificationSettingsVC extends StatefulWidget {
  @override
  _EmailNotificationSettingsVCState createState() => _EmailNotificationSettingsVCState();
}

class _EmailNotificationSettingsVCState extends State<EmailNotificationSettingsVC> {
  ...
  getNotificationResultAPI() async {
    ...
    if (resData["status"] == 1) {
      ...
      setState(() {
        ...
        tempData["email_bank_transfer"].toString()=="0"?_switchValue1 = false:_switchValue1 = true;
        tempData["email_cash_request_payment_recieved"].toString()=="0"?_switchValue2 = false:_switchValue2 = true;
        tempData["email_cash_request_payment_send"].toString()=="0"?_switchValue3 = false:_switchValue3 = true;
        tempData["email_add_cash_denied"].toString()=="0"?_switchValue4 = false:_switchValue4 = true;
        tempData["email_cash_request_recieved"].toString()=="0"?_switchValue5 = false:_switchValue5 = true;
        tempData["email_cash_request_sent"].toString()=="0"?_switchValue6 = false:_switchValue6 = true;
        tempData["email_cash_request_denied"].toString()=="0"?_switchValue7 = false:_switchValue7 = true;
        tempData["email_join_pot_request"].toString()=="0"?_switchValue8 = false:_switchValue8 = true;
  ...
  updateNotificationAPI() async {
    ...
    Map data = {
      ...
      //
      "email_bank_transfer": _switchValue1==true?"1":"0",
      "email_cash_request_payment_recieved":_switchValue2==true?"1":"0",
      "email_cash_request_payment_send":_switchValue3==true?"1":"0",
      "email_add_cash_denied":_switchValue4==true?"1":"0",
      "email_cash_request_recieved":_switchValue5==true?"1":"0",
      "email_cash_request_sent":_switchValue6==true?"1":"0",
      "email_cash_request_denied":_switchValue7==true?"1":"0",
      "email_join_pot_request":_switchValue8==true?"1":"0",
     //
