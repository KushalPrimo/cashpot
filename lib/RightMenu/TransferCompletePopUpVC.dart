...
class TransferCompletePopUpVC extends StatefulWidget {
  @override
  _TransferCompletePopUpVCState createState() => _TransferCompletePopUpVCState();
}

class _TransferCompletePopUpVCState extends State<TransferCompletePopUpVC> {
  startTime() async {
